...
Scene* SolveEquationsScene::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = SolveEquationsScene::create();
...
//                                           "CloseNormal.png",
//                                           "CloseSelected.png",
//                                           CC_CALLBACK_1(SolveEquationsScene::menuCloseCallback, this)
//                                           );
//    
...
//    this->addChild(menu, 1);
    ...
    auto homeButton = MenuItemImage::create("homeButton.png", "homeButton.png",
                                            CC_CALLBACK_1(SolveEquationsScene::homeButtonCallback, this));
    
    homeButton->setScale(1.0f/2);
    ...
    Layer* keyboardLayer = KeyboardTray::create();
...
void SolveEquationsScene::homeButtonCallback(Object* pSender) {
//    Director::getInstance()->pushScene(HomeScene::createScene());
    Director::getInstance()->popScene();
    
}

void SolveEquationsScene::menuCloseCallback(Object* pSender)
{
